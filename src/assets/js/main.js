...
function toggleMenu() {
    ...
    if (!isOpen) {
        ...
        gsap.to([menuOverlayNav, menuOverlayFooter], {
            ...
            ease: "power2.inOut",
            onComplete: () =>
                gsap.set([menuOverlayNav, menuOverlayFooter], {
                    opacity: 1,
                }),
        });
        ...
        gsap.to([menuOverlayNav, menuOverlayFooter], {
            ...
            yoyo: true,
            ease: "power2.inOut",
            onComplete: () => gsap.set([menuOverlayNav, menuOverlayFooter], { opacity: 0 }),
        });
    ...
    function animate() {
        ...
        if (isDragging && Math.sqrt(currentX * currentX + currentY * currentY) > 20) {
            ...
            if (segment !== activeSegment) {
                ...
                segment.style.animation = "flickerHover 0.35s ease-in-out forwards";
                segment.querySelector(".segment-content").style.animation =
                    "contentFlickerHover 0.35s ease-in-out forwards";
